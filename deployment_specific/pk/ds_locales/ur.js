const en = {
  'comming_soon': 'جلد آرہا ہے',
  'coming_soon_2020': 'دسمبر 2024 میں جلد آرہا ہے!',
  ...
  'report': 'رپورٹ شامل کریں۔',
  'add_report': 'سیلاب کی اطلاع دیں۔',
  ...
  'search_ph': 'تلاش کریں۔',
  'social_media_popup_header': 'کسی آفت کی اطلاع بذریعہ:',
  'banner_text': '<p><a class="social-media-link" href="https://bit.ly/BencanaBotWA">واٹس ایپ</a>,  <a class="social-media-link" href="https://m.me/petabencana.id">فیس بک میسنجر</a>, <a class="social-media-link" href="https://t.me/bencanabot">ٹیلی گرام</a>کے ذریعے اپنے آس پاس کی آفات کی اطلاع دیں ..کے ذریعے اپنے آس پاس کی آفات کی اطلاع دیں </p>',
  'training_banner_text': '<p>Ito ang plataporma nang pagsasanay.</p>',
  'popup_text': 'مقام کے لحاظ سے تباہی کی معلومات تلاش کریں:',
  'popup_footer': 'TabahiNaqsha.pk ایک <i>لائیو <i/> جو نقشہ <i>حقیقی وقت</i> میں تباہی کی معلومات کو ظاہر کرتا ہے۔.تاریخی اعداد و شمار کے لیے، براہ کرم <a href="https://www.tabahinaqsha.pk/" target="_blank">tabahinaqsha.pk</a>  ملاحظہ کریں۔',
  'search_header': 'علاقہ منتخب کریں۔',
  'flood': 'سیلاب',
  'eq': 'Earthquake',
  'fire': 'Forest Fire',
  'haze': 'Haze',
  ...
  'prep_menu': {
    'btn_names': {
      'drain': 'بند نالیاں',
      'desilting': 'ڈیسلٹنگ',
      'canalrepair': 'نہر کی مرمت',
      'treeclearing': 'گرا ہوا درخت'
    }
  },
  'web_menu': {
    'tab_names': {
  ...
  'report_info': {
    ...
    'water_depth': 'سیلاب کی گہرائی',
    'disturbance_key': 'خلل:',
    'access_key': 'رسائی:',
    'structure_key': 'ڈھانچے کی ناکامی:',
    'source': 'ماخذ',
    'flagReport_Title': 'اس رپورٹ کو نامناسب قرار دیں',
    'flagReport_button': 'ہمیں مزید بتائیں',
    'flagReport_email': 'info@tabahinaqsha.pk',
    'share': 'اس رپورٹ کا اشتراک کریں',
    'conditions': [
      'Light Disturbance',
  ...
  'report_content': {
    ...
    'youtube': {
      'title': 'سبق آموز ویڈیو دیکھیں'
    },
    'whatsapp': {
      'title': 'واٹس ایپ کے ذریعے رپورٹ کریں۔',
      'steps': [
    ...
    'twitter': {
      'title': 'ٹویٹر کے ذریعے رپورٹ کریں۔',
      'steps': [
    ...
    'facebook': {
      'title': 'فیس بک کے ذریعے رپورٹ کریں۔',
      'steps': [
  ...
  'info_content': {
    'intro': 'TabaahiNaqsha.pk ہنگامی واقعات کے دوران سوشل میڈیا کے استعمال کو حقیقی وقت میں خطرے کی تصدیق شدہ معلومات کو جمع کرنے ، ترتیب دینے اور ظاہر کرنے کے لئے استعمال کرتا ہے.',
    'infoLink': '<a href="https://info.petabencana.id/" target="_blank">To know more, visit Petabencana Foundation</a>',
    'p1': 'یاسان پیٹا بینکانا کے زیر انتظام ، جنوبی اور جنوب مشرقی ایشیاء میں میگاٹیوں میں ہنگامی ردعمل اور تباہی کے انتظام کے لئے ایک آزاد ، شفاف پلیٹ فارم کے طور پر ، پلیٹ فارم متعدد شراکت داروں کے ساتھ تعاون کے ذریعے ممکن بنایا گیا ہے:',
    'p2': '',
    'p3': 'تباہی کا نقشہ جمع ، طرح, اور خاص طور پر تیار شدہ کونگیٹی اوپن سورس سافٹ ویئر کا استعمال کرتے ہوئے اعداد و شمار کا تصور کرتا ہے - ہنگامی ردعمل اور تباہی کے انتظام کے لئے ایک انٹرپرائز لیول پلیٹ فارم - معاشرتی اور ڈیجیٹل میڈیا کے شور کو تنقیدی معلومات میں تبدیل کرنے کے لئے رہائشی ، برادری اور سرکاری ایجنسیاں. پلیٹ فارم “ کو اپناتا ہے لوگ بہترین سینسر ” نمونہ ہیں ، جہاں تصدیق شدہ رپورٹس براہ راست سڑک کی سطح پر صارفین سے اس انداز میں جمع کی جاتی ہیں جو مہنگے اور وقت استعمال کرنے والے ڈیٹا پروسیسنگ کو دور کرتی ہے. یہ فریم ورک درست ، ریئل ٹائم ڈیٹا تیار کرتا ہے جو صارفین اور پہلے جواب دہندگان کے لئے فوری طور پر دستیاب ہوجاتا ہے.',
    'partners': {
