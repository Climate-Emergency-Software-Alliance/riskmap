const en = {
  ...
  popup_footer:
    'TabahiNaqsha.pk a <i>live</> map displaying <i>real-time</i> disaster information. For historical data, please visit <a href="https://info.tabahinaqsha.pk/" target="_blank">info.TabahiNaqsha.pk</a>.',
  ...
  report_info: {
    ...
    flagReport_email: 'info@tabahinaqsha.pk',
    share: 'Share this report',
    conditions: ['Light Disturbance', 'Moderate Disturbance', 'Heavy Disturbance'],
    structure_failures: ['Cracking', 'Partially Collapsed', 'Fully Collapsed'],
    ...
    visibilityValues: ['Good', 'Moderate', 'Poor'],
    airQualityKey: 'Air Quality:',
    airQualityValues: ['', 'Moderate', 'Poor', 'Severe', 'Hazardous'],
    impactKey: 'Impact:',
    impactValues: ['Low Disruption', 'Medium Disruption', 'High Disruption'],
    signsKey: 'Symptoms:',
    signsValues: [
    ...
    evacuateVal: ['yes', 'no'],
    peopleValues: ['', '< 5 people', '5 - 50 people', '> 50 people'],
  ...
  report_content: {
    ...
    whatsapp: {
      ...
      steps: [
        ...
        'Check TabahiNaqsha.pk on your browser for up-to-date disaster information.'
      ]
    },
    twitter: {
    ...
    facebook: {
      ...
      steps: [
        'Search <a href="https://m.me/tabahinaqsha.pk">TabahiNaqsha.pk</a> on Facebook Messenger',
        'Click on “Get Started” and select the disaster to report',
        'Tabahinaqsha.pk will send you a one-time link to submit a disaster report',
        'Open the link and follow the instructions to input hazard location, upload photo and description',
        'TabahiNaqsha.pk will send you a reply with a link to your report',
        'Check TabahiNaqsha.pk on your browser for up-to-date disaster information'
      ]
    },
    web: {
      ...
      steps: [
        'Open www.tabahinaqsha.pk on your browser',
        ...
        'Check www.tabahinaqsha.pk on your browser for up-to-date disaster information'
      ]
    }
  },
  info_content: {
    intro:
      'TabahiNaqsha.pk harnesses the use of social media during emergency events to gather, sort, and display confirmed hazard information in real-time.',
    infoLink: '<a href="https://info.tabahinaqsha.pk/" target="_blank">To know more, visit TabahiNaqsha Foundation</a>',
    p1: 'Run by <a href="https://info.tabahinaqsha.pk/" target="_blank">TabahiNaqsha.pk</a>, as a free, transparent platform for emergency response and disaster management in megacities in South and Southeast Asia, the platform is made possible through collaboration with several partners:',
    p2: '',
    p3: 'TabahiNaqsha.pk gathers, sorts, and visualizes data using specially developed CogniCity Open Source Software - an enterprise-level platform for emergency response and disaster management - to transforms the noise of social and digital media into critical information for residents, communities, and government agencies. The platform adopts a “people are the best sensors” paradigm, where confirmed reports are collected directly from the users at street level in a manner that removes expensive and time-consuming data processing. This framework creates accurate, real-time data which is immediately made available for users and first responders.',
    partners: {
    ...
    USAID:
      'This website was made possible with the support of the American People through the U.S. Agency for International Development. This is not an official USAID or U.S. Government website. The contents of this website are the sole responsibility of the authors and do not necessarily reflect the views of USAID of the U.S. Government.'
  },
  legend: {
    title: 'Legend',
