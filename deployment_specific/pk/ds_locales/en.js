const en = {
  ...
  'banner_text': '<p>Extreme weather warning in effect. Report disasters near you via <a class="social-media-link" href="https://bit.ly/BencanaBotWA">WhatsApp</a>,  <a class="social-media-link" href="https://m.me/TabahiNaqsha.pk">Facebook Messenger</a> ,  <a class="social-media-link" href="https://t.me/bencanabot">Telegram</a>.</p>',
  'training_banner_text': '<p>Ito ang plataporma nang pagsasanay.</p>',
  'popup_text': 'Search for disaster location:',
  'popup_footer': 'TabahiNaqsha.pk a <i>live</> map displaying <i>real-time</i> disaster information. For historical data, please visit <a href="https://info.tabahinaqsha.pk/" target="_blank">info.TabahiNaqsha.pk</a>.',
  ...
  'info_content': {
    'intro': 'TabahiNaqsha.pk harnesses the use of social media during emergency events to gather, sort, and display confirmed hazard information in real-time.',
