const en = {
  ...
  popup_footer:
    'aafatinfo.pk a <i>live</> map displaying <i>real-time</i> disaster information. For historical data, please visit <a href="https://info.aafatinfo.pk/" target="_blank">info.aafatinfo.pk</a>.',
  ...
  report_info: {
    ...
    flagReport_email: 'info@aafatinfo.pk',
  ...
  report_content: {
    ...
    whatsapp: {
      ...
      steps: [
        ...
        'Check aafatinfo.pk on your browser for up-to-date disaster information.'
      ]
    },
    twitter: {
    ...
    facebook: {
      ...
      steps: [
        'Search <a href="https://m.me/aafatinfo.pk">aafatinfo.pk</a> on Facebook Messenger',
        'Click on “Get Started” and select the disaster to report',
        'aafatinfo.pk will send you a one-time link to submit a disaster report',
        'Open the link and follow the instructions to input hazard location, upload photo and description',
        'aafatinfo.pk will send you a reply with a link to your report',
        'Check aafatinfo.pk on your browser for up-to-date disaster information'
      ]
    },
    web: {
      ...
      steps: [
        'Open www.aafatinfo.pk on your browser',
        ...
        'Check www.aafatinfo.pk on your browser for up-to-date disaster information'
      ]
    }
  },
  info_content: {
    intro:
      'aafatinfo.pk harnesses the use of social media during emergency events to gather, sort, and display confirmed hazard information in real-time.',
    infoLink: '<a href="https://info.aafatinfo.pk/" target="_blank">To know more, visit aafatinfo Foundation</a>',
    p1: 'Run by <a href="https://info.aafatinfo.pk/" target="_blank">aafatinfo.pk</a>, as a free, transparent platform for emergency response and disaster management in megacities in South and Southeast Asia, the platform is made possible through collaboration with several partners:',
    p2: '',
    p3: 'aafatinfo.pk gathers, sorts, and visualizes data using specially developed CogniCity Open Source Software - an enterprise-level platform for emergency response and disaster management - to transforms the noise of social and digital media into critical information for residents, communities, and government agencies. The platform adopts a “people are the best sensors” paradigm, where confirmed reports are collected directly from the users at street level in a manner that removes expensive and time-consuming data processing. This framework creates accurate, real-time data which is immediately made available for users and first responders.',
    partners: {
